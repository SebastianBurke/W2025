...
public partial class Scenario1JmaTestContext : DbContext
{
    public Scenario1JmaTestContext()
    {
    }

    public Scenario1JmaTestContext(DbContextOptions<Scenario1JmaTestContext> options)
        : base(options)
    {
    }
